package com.framwork.arcanimator;
...
class ArcMetric {
    ...
    private void calcRadius(){
        ...
        mRadius = mStartEndSegment/ ArcUtils.sin(mAnimationDegree)* ArcUtils.sin(mSideDegree);
    }
    ...
    private void calcDegrees(){
        ...
        mZeroStartDegree = ArcUtils.acos((2 * Math.pow(mRadius, 2) - Math.pow(mZeroStartSegment, 2)) / (2 * Math.pow(mRadius, 2)));
        switch(mSide){
            case RIGHT:
