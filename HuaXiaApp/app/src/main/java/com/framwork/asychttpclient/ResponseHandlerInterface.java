...
public interface ResponseHandlerInterface {
     ...
     */
    void sendResponseMessage(String reqUrl, HttpResponse response) throws IOException;
     ...
     */
    void sendSuccessMessage(String reqString, int statusCode, Header[] headers, byte[] responseBody);
     ...
     */
    void sendFailureMessage(String reqString, int statusCode, Header[] headers, byte[] responseBody, Throwable error);
