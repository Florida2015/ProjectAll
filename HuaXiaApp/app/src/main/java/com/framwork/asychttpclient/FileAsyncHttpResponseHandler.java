...
public abstract class FileAsyncHttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    @Override
    public final void onFailure(String reqUrl,int statusCode, Header[] headers, byte[] responseBytes, Throwable throwable) {
        onFailure(reqUrl,statusCode, headers, throwable, getTargetFile());
    }
     ...
     */
    public abstract void onFailure(String reqUrl,int statusCode, Header[] headers, Throwable throwable, File file);

    @Override
    public final void onSuccess(String reqUrl,int statusCode, Header[] headers, byte[] responseBytes) {
