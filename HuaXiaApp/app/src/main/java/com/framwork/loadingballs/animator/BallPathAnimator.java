package com.framwork.loadingballs.animator;
...
import com.framwork.loadingballs.Ball;
...
//    ball.setPosition((int) coordinates[0], (int) coordinates[1]);//逆时针
    ball.setPosition((int) coordinates[1], (int) coordinates[0]);//顺时针
  }
