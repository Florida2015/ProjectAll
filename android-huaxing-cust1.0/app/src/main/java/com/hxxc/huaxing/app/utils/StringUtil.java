...
//    }
	...
	public static boolean isNumer(String str){
		Pattern pattern = Pattern.compile("[0-9]*");//纯数字
//		Pattern pattern_a = Pattern.compile("[a-zA-Z]*");//纯字母
		Matcher isNum = pattern.matcher(str);
//		Matcher isNum_a = pattern_a.matcher(str);
		if(isNum.matches()){//&&!isNum_a.matches()
			LogUtil.d("isNumer___ture  str="+str);
			return true;
		}
		LogUtil.d("isNumer___false   str="+str);
		return false;
	}
