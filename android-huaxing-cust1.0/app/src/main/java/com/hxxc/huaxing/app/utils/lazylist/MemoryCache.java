...
public class MemoryCache {
	...
	public void setLimit(long new_limit) {
		limit = new_limit;
		LogUtil.d(TAG, "MemoryCache will use up to " + limit / 1024. / 1024. + "MB");
	}
	...
	private void checkSize() {
		LogUtil.d(TAG, "cache size=" + size + " length=" + cache.size());
		if (size > limit) {
			...
			LogUtil.d(TAG, "Clean cache. New size " + cache.size());
		}
	}
