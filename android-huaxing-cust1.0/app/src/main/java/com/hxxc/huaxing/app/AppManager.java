...
//		SharedPreUtils.getInstanse().putKeyValue(HXXCApplication.getInstance(),UserInfoConfig.,"");
	...
	public void ExitLogin() {
		Api.uid="";
		Api.token="";
		SharedPreUtils.getInstanse().putKeyValue(HXXCApplication.getInstance(), UserInfoConfig.type_Logout,"1");
		...
		SharedPreUtils.getInstanse().putKeyValue(HXXCApplication.getInstance(),UserInfoConfig.spOpenEaccount,0);
		SharedPreUtils.getInstanse().putKeyValue(HXXCApplication.getInstance(), UserInfoConfig.spEaccountClick,0);
