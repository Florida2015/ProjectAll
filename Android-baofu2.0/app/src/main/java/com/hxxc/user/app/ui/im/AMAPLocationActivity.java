 ...
 */
public class AMAPLocationActivity extends ToolbarActivity implements View.OnClickListener, LocationSource, GeocodeSearch.OnGeocodeSearchListener, AMapLocationListener, AMap.OnCameraChangeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mButtonRight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mMsg != null) {
                    ImUtils.getInstance().getLastLocationCallback().onSuccess(mMsg);
                    ImUtils.getInstance().setLastLocationCallback(null);
                    finish();
                } else {
                    ImUtils.getInstance().getLastLocationCallback()
                            .onFailure("定位失败");
                }
            }
        });
    ...
    private void initAmap() {
        ...
        if (getIntent().hasExtra("location")) {
            ...
            if (model) {
                ...
                successDescripter = BitmapDescriptorFactory.fromResource(R.drawable.schedule_end_icon);
                aMap.addMarker(new MarkerOptions().anchor(0.5f, 0.5f)
                        .position(new LatLng(mMsg.getLat(), mMsg.getLng())).title(mMsg.getPoi())    //.icon(successDescripter)
    ...
    public void onRegeocodeSearched(RegeocodeResult regeocodeResult, int i) {
        if (i == 0) {
            if (regeocodeResult != null && regeocodeResult.getRegeocodeAddress() != null) {
                ...
                ToastUtil.ToastShort(AMAPLocationActivity.this,"没有搜索到结果");
            }
        } else {
            ToastUtil.ToastShort(AMAPLocationActivity.this, "搜索失败,请检查网络");
        }
    }
