...
import com.hxxc.user.app.ui.vh.InvitaitonRecordVH;
...
public class InvitationRecordFragment extends Fragment {
    ...
    public static InvitationRecordFragment newInstance(String orderStatus) {
...
//        mXRecyclerView.setParam("status",getArguments().getString("status"));
        mXRecyclerView.setView(InvitaitonRecordVH.class);
