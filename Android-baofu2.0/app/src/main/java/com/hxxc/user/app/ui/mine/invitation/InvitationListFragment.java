...
import com.hxxc.user.app.ui.vh.InvitationListVH;
...
public class InvitationListFragment extends Fragment {
    ...
    public static InvitationListFragment newInstance(String orderStatus) {
...
//        mXRecyclerView.setParam("status",getArguments().getString("status"));
        mXRecyclerView.setView(InvitationListVH.class);
