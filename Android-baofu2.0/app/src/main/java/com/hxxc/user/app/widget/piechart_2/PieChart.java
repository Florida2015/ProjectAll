...
public class PieChart extends View{
    ...
    private void init(){
        ...
        mPiePaint.setColor(Color.TRANSPARENT);//Color.RED

        mBlankPaint=new Paint(Paint.ANTI_ALIAS_FLAG);
        mBlankPaint.setColor(mContext.getResources().getColor(R.color.blue_1f80));//Color.WHITE
...
//        mTextPaint.setColor(Color.BLACK);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mRadius= (float) (Math.min(mWidth, mHeight)/2);//2*0.6
...
//        mInnerRadius= (float) (mRadius*0.6);//
        mInnerRadius= (float) (mRadius*0.96);//
    }
...
//        canvas.drawText(mText.substring((int) (index)), 0, getTextHeight(mTextPaint,mText)+6, mTextPaint);
        ...
        canvas.drawArc(mPieRect,-90,1f,true,mBlankPaint);
        canvas.drawArc(mPieRect,0,1f,true,mBlankPaint);
        canvas.drawArc(mPieRect,90,1f,true,mBlankPaint);
        canvas.drawArc(mPieRect,180,1f,true,mBlankPaint);
    }
...
//    }
    ...
    private void setValuesAndColors(){
        ...
        if (mElements!=null&&mElements.size()>0){
            ...
            BigDecimal totleAngel=BigDecimal.valueOf(360);//360-mElements.size()
