...
public class IntegralListActivity extends BaseRxActivity {
    ...
    @BindView(R.id.cTabLayout_integral_list)
    CommonTabLayout cTabLayout;
    @BindView(R.id.viewpager_integral_list)
    ViewPager viewpager;

    private ArrayList<Fragment> mFragments = new ArrayList<>();
    private String[] mTitles = {"全部", "获取", "使用"};
    private String[] mStatus = {"", "1", "0"};
    ...
    private void tabLayoutInit() {
        ...
        for (String status : mStatus) {
            mFragments.add(IntegralFragment.newInstance(status));//  状态
        }
